...
export class SeeGroupsShowComponent{
  ...
  share(): void {
    ...
    // console.log(this.idPersona.idPersona);
    ...
    // const newDetail = {idGrupos: this.group.idGrupos, idPersonas: this.idPersona.idPersona}
    // this.SeeGroupsService.postDetailsGroupPerson(this.GroupPersonC).subscribe(data =>
    //   console.log(data)
